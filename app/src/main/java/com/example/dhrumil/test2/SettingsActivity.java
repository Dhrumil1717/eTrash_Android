...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void userInfoDisplay(final CircleImageView profileImageView, final EditText fullNameEditText, final EditText userPhoneEditText, final EditText addressEditText) {
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child("Companies").child(Prevalent.currentOnlineCompany.getCompanyName());
    ...
    private void uploadImage() {
        ...
        if (imageUri != null) {
            final StorageReference fileRef = storageProfilePictureRef
                    .child(Prevalent.currentOnlineCompany.getCompanyName() + ".jpg");
            ...
            uploadTask.continueWithTask(new Continuation() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        ref.child(Prevalent.currentOnlineCompany.getCompanyName()).updateChildren(userMap);

                        progressDialog.dismiss();

                        startActivity(new Intent(SettingsActivity.this, CompanyCategories.class));
